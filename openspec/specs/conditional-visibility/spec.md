...
How a field or a whole section is shown or hidden from another field's value: where a condition's `field` reference resolves to, what hiding does and does not do to a saved value, and what the browser needs, and in what order, for a page to keep answering the admin as they work.
